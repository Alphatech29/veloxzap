...
import WalletCoin from './user/WalletCoin'
import WalletHistory from './user/WalletHistory'
import WalletDepositDetail from './user/WalletDepositDetail'
import WalletMarketDetail from './user/WalletMarketDetail'
import WalletNewsDetail from './user/WalletNewsDetail'
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        >
          ...
          <Route path="wallet/news/:id" element={<WalletNewsDetail />} />
