...
export async function purchaseInternet({ serviceID, billersCode, variation_code, amount, phone, pin }) {
  return apiFetch('/api/v1/users/purchase-internet', {
    method: 'POST',
    body: JSON.stringify({ serviceID, billersCode, variation_code, amount, phone, pin }),
  })
}
